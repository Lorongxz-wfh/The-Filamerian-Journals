...
class JournalResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'editor' => $this->editor,
            'cover_image' => $this->cover_image ? (url('/api/public/journals/' . ($this->slug ?: $this->id) . '/cover') . ($this->updated_at ? '?v=' . $this->updated_at->timestamp : '')) : null,
            'pdf_url' => $this->pdf_path ? (url('/api/public/journals/' . ($this->slug ?: $this->id) . '/pdf') . ($this->updated_at ? '?v=' . $this->updated_at->timestamp : '')) : null,
