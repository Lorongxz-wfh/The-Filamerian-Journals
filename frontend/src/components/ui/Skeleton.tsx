...
export const ChartSkeleton: React.FC<{ title?: string; height?: string; className?: string }> = ({
  height = 'h-52 sm:h-64',
  className = '',
}) => {
  return (
    <div className={cn("border border-border bg-surface p-4 sm:p-6 shadow-sm", className)}>
      <div className="flex items-center justify-between border-b border-border pb-3 mb-4 sm:pb-4 sm:mb-6">
        <div className="flex items-center gap-2">
      ...
      <div className={cn("w-full flex flex-col justify-between pt-2 px-1 relative", height)}>
        {/* Subtle background grid guide */}
        <div className="flex flex-col justify-between h-[80%] w-full opacity-30">
          <div className="border-b border-dashed border-border w-full" />
          <div className="border-b border-dashed border-border w-full" />
          <div className="border-b border-dashed border-border w-full" />
          <div className="border-b border-dashed border-border w-full" />
        </div>
        {/* Smooth shimmering wave placeholder */}
        <div className="absolute inset-x-4 bottom-8 top-6 flex items-center justify-center">
